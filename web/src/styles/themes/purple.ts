// Client主题配色方案 - 紫色系
export const clientPurpleTheme = {
  primary: {
    main: '#6f42c1',
    light: '#b47cff',
    dark: '#3d1b9b',
  ...
  gradient: {
    primary: 'linear-gradient(135deg, #6f42c1 0%, #3d1b9b 100%)',
    secondary: 'linear-gradient(135deg, #F8F8F8 0%, #F0F0F0 100%)',
    accent: 'linear-gradient(135deg, #3d1b9b 0%, #6f42c1 100%)',
    ...
    primaryHover: 'linear-gradient(135deg, #3d1b9b 0%, #6f42c1 100%)',
  },
  layout: {
    container: '#FFFFFF',
    content: '#FFFFFF',
...
export const clientPurpleDarkTheme = {
  primary: {
    main: '#6f42c1',
    light: '#b47cff',
    dark: '#3d1b9b',
  ...
  gradient: {
    primary: 'linear-gradient(135deg, #6f42c1 0%, #b47cff 100%)',
    secondary: 'linear-gradient(135deg, #1A1A1A 0%, #000000 100%)',
    accent: 'linear-gradient(135deg, #b47cff 0%, #6f42c1 100%)',
    ...
    primaryHover: 'linear-gradient(135deg, #b47cff 0%, #6f42c1 100%)',
  },
  layout: {
    container: '#000000',
    content: '#000000',
