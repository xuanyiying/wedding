...
export const clientBlueTheme = {
  ...
  gradient: {
    ...
    accent: 'linear-gradient(135deg, #0056b3 0%, #007bff 100%)',
    ...
    primaryHover: 'linear-gradient(135deg, #0056b3 0%, #007bff 100%)',
  },
  layout: {
    container: '#FFFFFF',
    content: '#FFFFFF',
...
export const clientBlueDarkTheme = {
  primary: {
    main: '#007bff',
    light: '#66b2ff',
    dark: '#0056b3',
  ...
  gradient: {
    primary: 'linear-gradient(135deg, #007bff 0%, #66b2ff 100%)',
    secondary: 'linear-gradient(135deg, #1A1A1A 0%, #000000 100%)',
    accent: 'linear-gradient(135deg, #66b2ff 0%, #007bff 100%)',
    ...
    primaryHover: 'linear-gradient(135deg, #66b2ff 0%, #007bff 100%)',
  },
  layout: {
    container: '#000000',
    content: '#000000',
