...
CREATE TABLE IF NOT EXISTS `schedules` (
                             ...
                             `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'available' COMMENT '日程状态',
                             ...
                             `deleted_at` datetime DEFAULT NULL COMMENT '删除时间',
                             PRIMARY KEY (`id`),
                             KEY `idx_schedules_user_id_date` (`user_id`,`date`),
                             KEY `idx_schedules_customer_id` (`customer_id`),
                             KEY `idx_schedules_status` (`status`),
                             KEY `idx_schedules_date_time` (`date`,`time_slot`),
...
CREATE TABLE IF NOT EXISTS `users` (
                         ...
                         `price_range` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '价格范围',
                         `min_price` decimal(10, 2) DEFAULT NULL COMMENT '市场价格',
                          `max_price` decimal(10, 2) DEFAULT NULL COMMENT '服务价格',
                         `is_public` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否公开个人资料',
                         PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `works` (
                         ...
                         `customer` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户名称',
